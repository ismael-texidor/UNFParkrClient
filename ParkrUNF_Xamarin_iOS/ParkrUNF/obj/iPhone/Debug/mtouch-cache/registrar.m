...
static BOOL native_to_managed_trampoline_7 (id self, SEL _cmd, MonoMethod **managed_method_ptr, NSString * p0, id p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_14 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, NSInteger p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
static BOOL native_to_managed_trampoline_17 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, id p1, NSInteger p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [3];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_18 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, BOOL p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_20 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, CGPoint p1, CGPoint* p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [3];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_21 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, id p1, CGFloat p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [3];
	MonoObject *mthis;
...
static NSInteger native_to_managed_trampoline_23 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, NSInteger p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.AppDelegate, ParkrUNF", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "ParkrUNF.AppDelegate, ParkrUNF", "set_Window");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "ParkrUNF.AppDelegate, ParkrUNF", ".ctor");
	}
@end
...
@interface SettingViewController : UIViewController {
	...
	@property (nonatomic, assign) id blueLot;
	@property (nonatomic, assign) id facultyLot;
	@property (nonatomic, assign) id grayLot;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(id) blueLot;
	-(void) setBlueLot:(id)p0;
	-(id) facultyLot;
	-(void) setFacultyLot:(id)p0;
	-(id) grayLot;
	-(void) setGrayLot:(id)p0;
	-(void) viewDidLoad;
...
@implementation SettingViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.SettingViewController, ParkrUNF", "get_blueLot");
	}

	-(void) setBlueLot:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UISwitch, Xamarin.iOS", "ParkrUNF.SettingViewController, ParkrUNF", "set_blueLot");
	}

	-(id) facultyLot
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.SettingViewController, ParkrUNF", "get_facultyLot");
	}

	-(void) setFacultyLot:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UISwitch, Xamarin.iOS", "ParkrUNF.SettingViewController, ParkrUNF", "set_facultyLot");
	}

	-(id) grayLot
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.SettingViewController, ParkrUNF", "get_grayLot");
	}

	-(void) setGrayLot:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UISwitch, Xamarin.iOS", "ParkrUNF.SettingViewController, ParkrUNF", "set_grayLot");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.SettingViewController, ParkrUNF", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.SettingViewController, ParkrUNF", "DidReceiveMemoryWarning");
	}
...
@interface LoginViewController : UIViewController {
	...
	@property (nonatomic, assign) id bypassLoginSegue;
	@property (nonatomic, assign) id loginLabel;
	@property (nonatomic, assign) id passwordHash;
	...
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(id) bypassLoginSegue;
	-(void) setBypassLoginSegue:(id)p0;
	-(id) loginLabel;
	-(void) setLoginLabel:(id)p0;
	-(id) passwordHash;
	-(void) setPasswordHash:(id)p0;
	-(id) usernameText;
	-(void) setUsernameText:(id)p0;
	-(void) viewDidLoad;
	-(void) didReceiveMemoryWarning;
	-(void) prepareForSegue:(id)p0 sender:(id)p1;
	-(BOOL) shouldPerformSegueWithIdentifier:(NSString *)p0 sender:(id)p1;
	-(void) bypassLoginClick:(id)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation LoginViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.LoginViewController, ParkrUNF", "get_bypassLoginSegue");
	}

	-(void) setBypassLoginSegue:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "ParkrUNF.LoginViewController, ParkrUNF", "set_bypassLoginSegue");
	}

	-(id) loginLabel
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.LoginViewController, ParkrUNF", "get_loginLabel");
	}

	-(void) setLoginLabel:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "ParkrUNF.LoginViewController, ParkrUNF", "set_loginLabel");
	}

	-(id) passwordHash
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.LoginViewController, ParkrUNF", "get_passwordHash");
	}

	-(void) setPasswordHash:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "ParkrUNF.LoginViewController, ParkrUNF", "set_passwordHash");
	}

	-(id) usernameText
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.LoginViewController, ParkrUNF", "get_usernameText");
	}

	-(void) setUsernameText:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "ParkrUNF.LoginViewController, ParkrUNF", "set_usernameText");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.LoginViewController, ParkrUNF", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.LoginViewController, ParkrUNF", "DidReceiveMemoryWarning");
	}

	-(void) prepareForSegue:(id)p0 sender:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, p1, "UIKit.UIStoryboardSegue, Xamarin.iOS", "Foundation.NSObject, Xamarin.iOS", "ParkrUNF.LoginViewController, ParkrUNF", "PrepareForSegue");
	}

	-(BOOL) shouldPerformSegueWithIdentifier:(NSString *)p0 sender:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "System.String, mscorlib", "Foundation.NSObject, Xamarin.iOS", "ParkrUNF.LoginViewController, ParkrUNF", "ShouldPerformSegue");
	}

	-(void) bypassLoginClick:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "ParkrUNF.LoginViewController, ParkrUNF", "bypassLoginClick");
	}
...
@interface MainViewController : UIViewController {
	...
	@property (nonatomic, assign) id alredyCheckedIn;
	@property (nonatomic, assign) id checkIntoText;
	@property (nonatomic, assign) id checkOutText;
	@property (nonatomic, assign) id lotImage;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(id) alredyCheckedIn;
	-(void) setAlredyCheckedIn:(id)p0;
	-(id) checkIntoText;
	-(void) setCheckIntoText:(id)p0;
	-(id) checkOutText;
	-(void) setCheckOutText:(id)p0;
	-(id) lotImage;
	-(void) setLotImage:(id)p0;
	-(void) viewDidLoad;
	-(void) didReceiveMemoryWarning;
	-(void) checkOutClick:(id)p0;
	-(void) prepareForSegue:(id)p0 sender:(id)p1;
	-(BOOL) shouldPerformSegueWithIdentifier:(NSString *)p0 sender:(id)p1;
	-(void) checkInClick:(id)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation MainViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.MainViewController, ParkrUNF", "get_alredyCheckedIn");
	}

	-(void) setAlredyCheckedIn:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "set_alredyCheckedIn");
	}

	-(id) checkIntoText
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.MainViewController, ParkrUNF", "get_checkIntoText");
	}

	-(void) setCheckIntoText:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "set_checkIntoText");
	}

	-(id) checkOutText
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.MainViewController, ParkrUNF", "get_checkOutText");
	}

	-(void) setCheckOutText:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "set_checkOutText");
	}

	-(id) lotImage
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.MainViewController, ParkrUNF", "get_lotImage");
	}

	-(void) setLotImage:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIImageView, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "set_lotImage");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.MainViewController, ParkrUNF", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.MainViewController, ParkrUNF", "DidReceiveMemoryWarning");
	}

	-(void) checkOutClick:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "checkOutClick");
	}

	-(void) prepareForSegue:(id)p0 sender:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, p1, "UIKit.UIStoryboardSegue, Xamarin.iOS", "Foundation.NSObject, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "PrepareForSegue");
	}

	-(BOOL) shouldPerformSegueWithIdentifier:(NSString *)p0 sender:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "System.String, mscorlib", "Foundation.NSObject, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "ShouldPerformSegue");
	}

	-(void) checkInClick:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "ParkrUNF.MainViewController, ParkrUNF", "checkInClick");
	}
...
@interface RegisterViewController : UIViewController {
	...
	@property (nonatomic, assign) id passwordHash;
	@property (nonatomic, assign) id registerButton;
	...
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(id) firstName;
	-(void) setFirstName:(id)p0;
	-(id) lastName;
	-(void) setLastName:(id)p0;
	-(id) passwordHash;
	-(void) setPasswordHash:(id)p0;
	-(id) registerButton;
	-(void) setRegisterButton:(id)p0;
	-(id) userName;
	-(void) setUserName:(id)p0;
	-(void) viewDidLoad;
	-(void) didReceiveMemoryWarning;
	-(BOOL) shouldPerformSegueWithIdentifier:(NSString *)p0 sender:(id)p1;
	-(void) registerClick:(id)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation RegisterViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.RegisterViewController, ParkrUNF", "get_firstName");
	}

	-(void) setFirstName:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "ParkrUNF.RegisterViewController, ParkrUNF", "set_firstName");
	}

	-(id) lastName
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.RegisterViewController, ParkrUNF", "get_lastName");
	}

	-(void) setLastName:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "ParkrUNF.RegisterViewController, ParkrUNF", "set_lastName");
	}

	-(id) passwordHash
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.RegisterViewController, ParkrUNF", "get_passwordHash");
	}

	-(void) setPasswordHash:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "ParkrUNF.RegisterViewController, ParkrUNF", "set_passwordHash");
	}

	-(id) registerButton
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.RegisterViewController, ParkrUNF", "get_registerButton");
	}

	-(void) setRegisterButton:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "ParkrUNF.RegisterViewController, ParkrUNF", "set_registerButton");
	}

	-(id) userName
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.RegisterViewController, ParkrUNF", "get_userName");
	}

	-(void) setUserName:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "ParkrUNF.RegisterViewController, ParkrUNF", "set_userName");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.RegisterViewController, ParkrUNF", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.RegisterViewController, ParkrUNF", "DidReceiveMemoryWarning");
	}

	-(BOOL) shouldPerformSegueWithIdentifier:(NSString *)p0 sender:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "System.String, mscorlib", "Foundation.NSObject, Xamarin.iOS", "ParkrUNF.RegisterViewController, ParkrUNF", "ShouldPerformSegue");
	}

	-(void) registerClick:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "ParkrUNF.RegisterViewController, ParkrUNF", "registerClick");
	}
...
@implementation LotViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "ParkrUNF.LotViewController, ParkrUNF", "get_lotImage");
	}

	-(void) setLotImage:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIImageView, Xamarin.iOS", "ParkrUNF.LotViewController, ParkrUNF", "set_lotImage");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.LotViewController, ParkrUNF", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "ParkrUNF.LotViewController, ParkrUNF", "DidReceiveMemoryWarning");
	}
...
@implementation UIKit_UIWebView__UIWebViewDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_17 (self, _cmd, &managed_method, p0, p1, p2, "UIKit.UIWebView, Xamarin.iOS", "Foundation.NSUrlRequest, Xamarin.iOS", "UIKit.UIWebViewNavigationType, Xamarin.iOS", "UIKit.UIWebView+_UIWebViewDelegate, Xamarin.iOS", "ShouldStartLoad");
	}
...
@implementation Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Auth._MobileServices.FormAuthenticatorController+FormDelegate, Microsoft.WindowsAzure.Mobile.Ext", "RowSelected");
	}
...
@implementation Xamarin_Auth__MobileServices_WebAuthenticatorController_WebViewDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_17 (self, _cmd, &managed_method, p0, p1, p2, "UIKit.UIWebView, Xamarin.iOS", "Foundation.NSUrlRequest, Xamarin.iOS", "UIKit.UIWebViewNavigationType, Xamarin.iOS", "Xamarin.Auth._MobileServices.WebAuthenticatorController+WebViewDelegate, Microsoft.WindowsAzure.Mobile.Ext", "ShouldStartLoad");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, p1, "UIKit.UIWebView, Xamarin.iOS", "Foundation.NSError, Xamarin.iOS", "Xamarin.Auth._MobileServices.WebAuthenticatorController+WebViewDelegate, Microsoft.WindowsAzure.Mobile.Ext", "LoadFailed");
	}
...
@implementation Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDataSource { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_22 (self, _cmd, &managed_method, p0, "UIKit.UITableView, Xamarin.iOS", "Xamarin.Auth._MobileServices.FormAuthenticatorController+FormDataSource, Microsoft.WindowsAzure.Mobile.Ext", "NumberOfSections");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_24 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Auth._MobileServices.FormAuthenticatorController+FormDataSource, Microsoft.WindowsAzure.Mobile.Ext", "GetCell");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "ParkrUNF.AppDelegate, ParkrUNF", NULL },
		{"SettingViewController", "ParkrUNF.SettingViewController, ParkrUNF", NULL },
		{"LoginViewController", "ParkrUNF.LoginViewController, ParkrUNF", NULL },
		{"MainViewController", "ParkrUNF.MainViewController, ParkrUNF", NULL },
		{"RegisterViewController", "ParkrUNF.RegisterViewController, ParkrUNF", NULL },
		{"LotViewController", "ParkrUNF.LotViewController, ParkrUNF", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [3].handle = objc_getClass ("ACAccount");
	__xamarin_class_map [4].handle = objc_getClass ("ACAccountStore");
	...
	__xamarin_class_map [9].handle = objc_getClass ("NSHTTPCookie");
	__xamarin_class_map [10].handle = objc_getClass ("NSHTTPCookieStorage");
	...
	__xamarin_class_map [50].handle = objc_getClass ("UITextSelectionRect");
	...
	__xamarin_class_map [55].handle = objc_getClass ("NSURLCache");
	...
	__xamarin_class_map [63].handle = objc_getClass ("UITableViewController");
	...
	__xamarin_class_map [81].handle = [SettingViewController class];
	__xamarin_class_map [82].handle = [LoginViewController class];
	__xamarin_class_map [83].handle = [MainViewController class];
	__xamarin_class_map [84].handle = [RegisterViewController class];
	__xamarin_class_map [85].handle = [LotViewController class];
	__xamarin_class_map [86].handle = objc_getClass ("CoreLocation_CLLocationManager__CLLocationManagerDelegate");
	__xamarin_class_map [87].handle = objc_getClass ("UIKit_UIAlertView__UIAlertViewDelegate");
	__xamarin_class_map [88].handle = objc_getClass ("UIKit_UIBarButtonItem_Callback");
	...
	__xamarin_class_map [96].handle = [Xamarin_Controls__MobileServices_ProgressLabel class];
	__xamarin_class_map [97].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDelegate class];
	__xamarin_class_map [98].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController class];
	__xamarin_class_map [99].handle = [Xamarin_Auth__MobileServices_WebAuthenticatorController_WebViewDelegate class];
	__xamarin_class_map [100].handle = [Xamarin_Auth__MobileServices_WebAuthenticatorController class];
	__xamarin_class_map [101].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController_FieldCell class];
	__xamarin_class_map [102].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDataSource class];
